        ...
        <main>
            <section className="pt-32 pb-20 md:pt-48 md:pb-32 px-4 bg-diodona-beige">
                <div className="container mx-auto max-w-4xl">
                    <h1 className="font-serif text-5xl md:text-7xl text-diodona-green mb-12 text-center tracking-wide">
                        Groepen
                    </h1>
                    ...
                    <div className="space-y-12 text-diodona-green">
                        ...
                        <div className="bg-white p-8 md:p-12 rounded-sm shadow-lg border border-gray-100">
                            <h2 className="font-serif text-3xl md:text-4xl mb-6 tracking-wide">Diner voor Groepen</h2>
                        ...
                        <div className="bg-diodona-green text-diodona-beige p-8 md:p-12 rounded-sm shadow-lg">
                            <h2 className="font-serif text-3xl md:text-4xl mb-6 tracking-wide">Groepslunch Special</h2>
                            <p className="text-lg leading-relaxed mb-6">
                        ...
                        {/* Shared Dining */}
                        <div className="bg-white p-8 md:p-12 rounded-sm shadow-lg border border-gray-100">
                            <h2 className="font-serif text-3xl md:text-4xl mb-6 tracking-wide">Shared Dining voor Groepen</h2>
                            <p className="text-lg leading-relaxed mb-6">
                        ...
                        {/* Reserveren */}
                        <div className="bg-diodona-beige border-2 border-diodona-green/20 p-8 md:p-12 rounded-sm text-center">
                            <h2 className="font-serif text-3xl md:text-4xl mb-6 tracking-wide">Reserveren</h2>
